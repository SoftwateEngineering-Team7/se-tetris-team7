...
public class ScreenPresetTest {
    ...
    public void testSetCurrentPresetToSmall() {
        ...
        assertEquals("현재 프리셋은 SMALL이어야 합니다", 
                    ScreenPreset.SMALL_STRING, ScreenPreset.getCurrentPreset());
        assertEquals("SMALL의 너비는 800이어야 합니다", ScreenPreset.SMALL_WIDTH, ScreenPreset.getWidth());
        assertEquals("SMALL의 높이는 600이어야 합니다", ScreenPreset.SMALL_HEIGHT, ScreenPreset.getHeight());
    }
    ...
    public void testSetCurrentPresetToMiddle() {
        ...
        assertEquals("MIDDLE의 너비는 1000이어야 합니다", ScreenPreset.MIDDLE_WIDTH, ScreenPreset.getWidth());
        assertEquals("MIDDLE의 높이는 700이어야 합니다", ScreenPreset.MIDDLE_HEIGHT, ScreenPreset.getHeight());
    }
    ...
    public void testSetCurrentPresetToLarge() {
        ...
        assertEquals("LARGE의 너비는 1200이어야 합니다", ScreenPreset.LARGE_WIDTH, ScreenPreset.getWidth());
        assertEquals("LARGE의 높이는 800이어야 합니다", ScreenPreset.LARGE_HEIGHT, ScreenPreset.getHeight());
    }
}
