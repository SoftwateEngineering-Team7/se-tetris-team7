package org.tetris.network.game.controller;
...
import org.tetris.game.controller.GameKeyHandler;
...
public class P2PGameController extends BaseController<P2PGameModel> implements RouterAware, GameViewCallback {
    ...
    private void setupPlayerSlots() {
        ...
        localPlayer = new PlayerSlot(localGameModel.getBoardModel(), localGameModel.getNextBlockModel(),
                localGameModel.getScoreModel(), renderer1);
        remotePlayer = new PlayerSlot(remoteGameModel.getBoardModel(), remoteGameModel.getNextBlockModel(),
                remoteGameModel.getScoreModel(), renderer2);
